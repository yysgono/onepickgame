...
export default function MyWorldcups() {
  ...
  return (
    <div style={{ maxWidth: 950, margin: "40px auto", background: "#fff", borderRadius: 18, padding: 32, minHeight: 400 }}>
      <h2 style={{ fontWeight: 900, fontSize: 29, marginBottom: 24, letterSpacing: -1, color: "#5542b8" }}>내가 만든 월드컵</h2>
      {myList.length === 0 ? (
        <div style={{ textAlign: "center", color: "#596579", marginTop: 70, fontSize: 21 }}>아직 만든 월드컵이 없습니다.</div>
      ) : (
