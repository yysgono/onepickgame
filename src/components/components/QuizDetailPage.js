        ...
        {phase === "setup" && (
          <>
            <div style={{ textAlign: "center", padding: "30px 10px 20px" }}>
              {quiz.thumbnail_url && (
                <MediaRenderer url={quiz.thumbnail_url} alt="" playable={false} style={{ width: "100%", maxWidth: 820, aspectRatio: "16/9", objectFit: "cover", border: "1.5px solid #cfd8e6", borderRadius: 12 }} />
              )}
