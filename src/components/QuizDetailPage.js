          ...
          <>
            ...
            <div style={{ textAlign: "center", padding: "30px 10px 20px" }}>
              ...
              {quiz.thumbnail_url && (
                ...
                <MediaRenderer url={quiz.thumbnail_url} alt={title || "Quiz"} playable={false} style={{
                ...
                return (
                  ...
                  <div key={`${q.id}-${ri}`} style={{ ...cardStyle, borderColor: record.correct ? "#bcdcca" : "#e2c0c5" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: q.image_url ? "120px 1fr" : "1fr", gap: 14, alignItems: "start" }}>
                      ...
                      {q.image_url && <MediaRenderer url={q.image_url} alt={localize(q.question_translations, q.question_text, lang) || title || "Quiz question"} playable={false} style={{ width: 120, height: 120, objectFit: "cover", border: "1px solid #d5dde9", borderRadius: 8 }} />}
                  ...
                  {recommended.map((item) => (
                    ...
                    <Link key={item.id} to={`/${lang}/quiz/${item.id}`} style={{ ...cardStyle, textDecoration: "none", padding: 0, overflow: "hidden", textAlign: "left", cursor: "pointer", color: "#202534" }}>
                      ...
                      <div style={{ aspectRatio: "16/9", background: "#f3f6fb", overflow: "hidden" }}>
                        ...
                        {item.thumbnail_url ? <MediaRenderer url={item.thumbnail_url} alt={localize(item.title_translations, item.title, lang) || item.title || "Quiz"} playable={false} style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : <div style={{ display: "grid", placeItems: "center", height: "100%", fontSize: 36 }}>?</div>}
