...
export default function Header({
  ...
  const personalPage = modePath === 'my-content' || modePath === 'my-worldcups' || (modePath === 'tier-list' && new URLSearchParams(location.search).get('mine') === '1');
...
>
        ...
        <div
          ...
          style={!isMobile ? { position: "absolute", right: 0, top: 0, bottom: 0, marginLeft: 0, zIndex: 3 } : undefined}
        >
