...
export default function SelectRoundPage({ cup, maxRound, candidates, onSelect }) {
  ...
  const selectWrap = { position: "relative", display: "inline-block", minWidth: 130, textAlign: "center" };
